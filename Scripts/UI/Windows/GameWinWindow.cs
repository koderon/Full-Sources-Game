...
namespace Gui
{
    ...
    public class GameWinWindow : Window, ISwitcherDayOrNight
    {
        [SerializeField]
        ...
        private void Start()
        {
            _likeButton.OnClick = go => Helper.GotoURL(_settings.UrlToLikeGame); 

            _repeatButton.OnClick = go => WindowManager.SetGameScreen(EWindowType.GameWindow, EWindowType.None, _typeGame, _modeGame);
